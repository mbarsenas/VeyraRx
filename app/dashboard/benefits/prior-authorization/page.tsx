...
import { priorAuthorizations } from "@/lib/mock-data/benefits";
  ...
  return (
    <>
      ...
      <article className="panelCard">
        ...
        {priorAuthorizations.map((item) => (
          <div key={item.medication} style={{ marginBottom: "18px" }}>
      ...
      <p className="demoDisclosure">Prototype authorization data only. No request has been submitted to a health plan or prescriber.</p>
    </>
  );
}
